...
set -ex && \
    ...
    go build \
        ...
        -ldflags "-s -w \
            -X github.com/operator-framework/ansible-operator-plugins/internal/version.Version=v1.41.0 \
            -X github.com/operator-framework/ansible-operator-plugins/internal/version.GitVersion=v1.41.0 \
            -X github.com/operator-framework/ansible-operator-plugins/internal/version.GitCommit=8e923f25256c2b64c85a2c9dfabd157e8f880ea8 \
            -X github.com/operator-framework/ansible-operator-plugins/internal/version.KubernetesVersion=v1.32.0 \
            -X github.com/operator-framework/ansible-operator-plugins/internal/version.ImageVersion=v1.41.0 \
        " \
