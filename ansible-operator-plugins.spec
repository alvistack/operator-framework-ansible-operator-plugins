...
set -ex && \
    ...
    go build \
        ...
        -ldflags "-s -w \
            -X github.com/operator-framework/ansible-operator-plugins/internal/version.Version=v1.40.0 \
            -X github.com/operator-framework/ansible-operator-plugins/internal/version.GitVersion=v1.40.0 \
            -X github.com/operator-framework/ansible-operator-plugins/internal/version.GitCommit=27bbbbb05f4ee3a96fda9e6e24b3090f9646459a \
            -X github.com/operator-framework/ansible-operator-plugins/internal/version.KubernetesVersion=v1.32.0 \
            -X github.com/operator-framework/ansible-operator-plugins/internal/version.ImageVersion=v1.40.0 \
        " \
