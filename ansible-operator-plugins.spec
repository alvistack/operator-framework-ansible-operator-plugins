...
set -ex && \
    ...
    go build \
        ...
        -ldflags "-s -w \
            -X github.com/operator-framework/ansible-operator-plugins/internal/version.Version=v1.42.0 \
            -X github.com/operator-framework/ansible-operator-plugins/internal/version.GitVersion=v1.42.0 \
            -X github.com/operator-framework/ansible-operator-plugins/internal/version.GitCommit=533bb426cb279e7afe6794b48c145fdd2674ebe9 \
            -X github.com/operator-framework/ansible-operator-plugins/internal/version.KubernetesVersion=v1.32.0 \
            -X github.com/operator-framework/ansible-operator-plugins/internal/version.ImageVersion=v1.42.0 \
        " \
